...
## Day 25: Java language foundations
...
## Day 26: Bitwise operations in Java

Objective: Use Java bitwise operators, masks, shifts, and unsigned-shift behavior deliberately.
...
Practice: Write a Java program with READ, WRITE, and EXEC bit flags. Combine flags, test one flag with &, clear one flag with ~, and print the results.

Quick check: Which Java right-shift operator fills with zero bits?

## Day 27: Java control flow
...
## Day 28: Methods, scope, and contracts
...
## Day 29: Classes, objects, and constructors
...
## Day 31: Encapsulation and invariants
...
## Day 32: Inheritance and polymorphism
...
## Day 33: Abstract classes and interfaces
...
## Day 34: Equality, comparison, and hashing
...
## Day 35: Generics and higher-order functions
...
## Day 36: Recursive lists and ADTs
...
## Day 37: ADTs and Java collections
...
## Day 40: Testing, debugging, and docs
...
## Day 41: Random test data in Java

Objective: Generate reproducible arrays, cases, and fixtures with Random and ThreadLocalRandom.
...
Practice: Generate a reproducible random int array with new Random(42), sort a copy, and print whether the sorted copy is nondecreasing.

Quick check: Why use a fixed random seed in tests?

## Day 42: Runtime benchmarking in Java

Objective: Measure elapsed time with nanoTime, warm up the JVM, and compare algorithms carefully.
...
Practice: Use System.nanoTime to time sorting arrays of at least two sizes. Warm up once, then print elapsed milliseconds for each size.

Quick check: Which Java method should you use for elapsed benchmark timing?

## Day 43: Algorithm analysis in Java
...
## Day 45: Packages, modules, and organization
