...
This project is a work in progress and is being continually improved.
...
To install the optional `Learn` launcher after trying the app:
...
Created and maintained by Ryu Hemingway. If you use or share this project,
please keep the copyright notice from the MIT License and cite the repository
